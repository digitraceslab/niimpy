...
def test_screen_duration():
    screen  = niimpy.reading.read_csv(niimpy.sampledata.TEST_SCREEN_1, tz=TZ)
    battery = niimpy.reading.read_csv(niimpy.sampledata.TEST_BATTERY_1, tz=TZ)
...
@pytest.fixture
def screen1():
    return niimpy.reading.read_csv_string("""\
time,screen_status
0,1
60,0
600,1
