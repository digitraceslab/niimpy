...
def test_app_features():
    ...
    assert user_comm.loc['2019-08-05 14:00:00+03:00']["duration"] == pytest.approx(594.99) 
    assert user_work.loc['2019-08-06 04:00:00+03:00']["duration"] == pytest.approx(778.0) 
    
    # TEST 2
    features ={app.app_count:{"app_column_name":"application_name", 
